...
// ---------------------------------------------------------------------------
// GLOBAL INTERACTION FUNCTIONS (Available via HTML inline onclick fallback)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// MAIN ENGINE: UPDATE DW_CCR DASHBOARD (METRICS, CHARTS & TABLES)
// ---------------------------------------------------------------------------
function updateDWCCRDashboard() {
    ...
    // Render Charts ONLY if Tab 1 (ccr-soporte) is active and canvas is visible
    if (window.Chart && currentTab === 'ccr-soporte') {
...
// ---------------------------------------------------------------------------
// CHART HELPER: DESTROY PREVIOUS CHARTS
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// INITIALIZATION ON DOM / SCRIPT LOAD
// ---------------------------------------------------------------------------
function initApp() {
